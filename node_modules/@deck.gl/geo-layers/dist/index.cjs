...
function getOSMTileIndices(viewport, maxZ, zRange, bounds) {
  const project = viewport instanceof import_core5._GlobeViewport && viewport.resolution ? (
...
var H3HexagonLayer = class extends import_core9.CompositeLayer {
  initializeState() {
  ...
  _calculateH3DataProps() {
    ...
    const { iterable, objectInfo } = (0, import_core9.createIterable)(this.props.data);
...
var H3ClusterLayer = class extends GeoCellLayer_default {
  ...
  updateState({ props, changeFlags }) {
    if (changeFlags.dataChanged || changeFlags.updateTriggersChanged && changeFlags.updateTriggersChanged.getHexagons) {
      ...
      const polygons = [];
      const { iterable, objectInfo } = (0, import_core10.createIterable)(data);
      for (const object of iterable) {
        objectInfo.index++;
...
var uniformBlock2 = `layout(std140) uniform meshUniforms {
  bool pickFeatureIds;
} mesh;
`;
var meshUniforms = {
...
var Tile3DLayer = class extends import_core11.CompositeLayer {
  initializeState() {
    if ("onTileLoadFail" in this.props) {
      import_core11.log.removed("onTileLoadFail", "onTileError")();
    }
    this.state = {
      layerMap: {},
      tileset3d: null,
  ...
  async _loadTileset(tilesetUrl) {
    ...
    const tilesetJson = await (0, import_core12.load)(actualTilesetUrl, loader, options.loadOptions);
  ...
  _makePointCloudLayer(tileHeader, oldLayer) {
    ...
    return new SubLayerClass({
      ...
      tile: tileHeader,
      data,
      coordinateSystem: import_core11.COORDINATE_SYSTEM.METER_OFFSETS,
  ...
  _makeSimpleMeshLayer(tileHeader, oldLayer) {
    ...
    const { attributes, indices, modelMatrix, cartographicOrigin, coordinateSystem = import_core11.COORDINATE_SYSTEM.METER_OFFSETS, material, featureIds } = content;
...
var TerrainLayer = class extends import_core13.CompositeLayer {
  updateState({ props, oldProps }) {
    ...
    if (props.workerUrl) {
      import_core13.log.removed("workerUrl", "loadOptions.terrain.workerUrl")();
    }
  }
